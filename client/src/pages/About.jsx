const About = () => {
  return (
    <div className="w-[90%] md:w-4/5 flex flex-col gap-9 text-[var(--text2)] mx-auto py-20">
      <h2 className="text-[30px] text-[var(--text1)]">About JJ Estate</h2>
      <p>
        JJ Estate is a leading real estate agency that specializes in helping
